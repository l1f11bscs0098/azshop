...
azshop.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (azshop.dataTable.selected[selector] === undefined) {
            azshop.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (! azshop.dataTable.selected[this.selector].includes(id)) {
            azshop.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        azshop.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = azshop.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return azshop.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        azshop.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        azshop.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return azshop.dataTable.selected[selector];
    }

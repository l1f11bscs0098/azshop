...
$(function () {
    ...
    var o = $.azshop.options;

    // Set up the object
    _init();

    // Activate layout
    $.azshop.layout.activate();
    ...
    if (o.sidebarPushMenu) {
        $.azshop.pushMenu.activate(o.sidebarToggleSelector);
    }
...
function _init() {
    ...
    $.azshop.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.azshop.options.screenSizes;
    ...
    // Tree
    $.azshop.tree = function (menu) {
        var animationSpeed = $.azshop.options.animationSpeed;

...
if (! function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('azshop.modules.core.config.core_modules'));
    }
}
...
if (! function_exists('azshop_version')) {
    /**
     * Get the azshop version.
     *
     * @return string
     */
    function azshop_version()
    {
        return azshop::VERSION;
    }
}

...
use Mejan\Stylist\Theme\Json;
use Mejan\Stylist\Theme\Theme;
...
class ThemeServiceProvider extends ServiceProvider
{
     ...
     *
     * @param \Mejan\Stylist\Theme\Theme $theme
     * @return void
     */
    ...
    private function loadConfigs(Theme $theme, $themeAlias)
    {
        collect([
            ...
            $this->mergeConfigFrom($path, "azshop.themes.{$themeAlias}.{$filename}");
        });
    }

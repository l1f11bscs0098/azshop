...
namespace azshop\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use azshop\Scaffold\Module\Generators\FilesGenerator;
use azshop\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \azshop\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \azshop\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \azshop\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \azshop\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The azshop {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The azshop {$moduleName} Module.\"," . PHP_EOL;
